...
@section('content')
    <div class="min-h-screen bg-slate-50 py-6">
        <div class="max-w-3xl mx-auto px-4">
            ...
            <div class="flex items-start gap-3 mb-6">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-1 flex items-center gap-1.5 text-xs text-slate-600">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5 text-emerald-500" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path d="M12 2a10 10 0 100 20 10 10 0 100-20zm-1 12l-3-3 1.4-1.4L11 11.2l4.6-4.6L17 8l-6 6z" />
                        </svg>
                    </div>
                </div>
            </div>
          ...
          hover:bg-emerald-100 transition">
                ...
                {{-- hidden input yg dikirim ke backend --}}
                ...
                {{-- hidden input untuk menyimpan kode voucher yang dipakai --}}
                ...
                <p class="text-[11px] text-slate-600 mb-3">
                    <a href="{{ route('login') }}" class="text-emerald-600 font-medium hover:underline">Masuk Akun</a>
                ...
                <form action="#" method="POST" class="space-y-3.5">
                    ...
                    <form id="donasiForm" action="{{ route('donasi.proses') }}" method="POST" class="space-y-4">
                        @csrf
               ...
               hover:brightness-105 active:scale-[0.99] transition">
                    ...
                    <div id="confirmModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40">
                        <div class="bg-white rounded-3xl shadow-2xl max-w-lg w-full mx-4 p-8 relative text-center">
                            ...
                            {{-- Tombol X --}}
                            <button type="button"
                                onclick="document.getElementById('confirmModal').classList.add('hidden'); document.getElementById('confirmModal').classList.remove('flex');"
                            ...
                            <div class="w-40 h-40 mx-auto mb-6">
                                <img src="{{ asset('images/confirm-illustration.png') }}" alt="Konfirmasi donasi"
                    ...
                    <div id="paymentModal" class="fixed inset-0 z-50 hidden items-start justify-center bg-black/40">
                        <div
                            class="mt-10 w-full max-w-md rounded-2xl bg-white shadow-xl max-h-[80vh] overflow-hidden flex flex-col">
                            ...
                            <div class="flex-1 overflow-y-auto">
                                ...
                                <div
                                    class="px-4 pt-3 pb-1 text-[11px] font-semibold text-slate-500 uppercase tracking-wide">
                                    E-Wallet
                                </div>
                                ...
                                <div class="divide-y divide-slate-100 text-sm">
                                    ...
                                    <button type="button"
                                        class="w-full flex items-center justify-between px-4 py-2.5 hover:bg-slate-50"
                                    ...
                                    <button type="button"
                                        ...
                                        <div class="flex items-center gap-2">
                                            <img src="{{ asset('images/shopeepay.png') }}" class="h-5"
                                                alt="ShopeePay">
                                            <span>ShopeePay</span>
                                        </div>
                                        <span class="text-slate-400">&rsaquo;</span>
                                ...
                                {{-- Virtual Account --}}
                                <div
                                    class="px-4 pt-4 pb-1 text-[11px] font-semibold text-slate-500 uppercase tracking-wide">
                                    Virtual Account
                                </div>
                            ...
                            <div class="px-4 py-4 space-y-3 text-sm">
                              ...
                              focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500"
                                ...
                                <div class="text-[11px] text-slate-600 leading-relaxed">
                                    <p>- Jika nominal voucher lebih kecil dari nominal donasi, maka nominal voucher yang
                                        akan diambil.</p>
                                    <p>- Jika nominal voucher lebih besar dari nominal donasi, maka pendonor hanya perlu
                                        membayar sisanya.
                                    </p>
                                </div>
                            </div>
    ...
    <path stroke-linecap="round" stroke-linejoin="round"
          d="M4.5 12.75l6 6 9-13.5" />
                            ...
                            toast.className =
                                `toast-show flex flex-col gap-2 bg-white border-l-4 ${borderColor}
    ...
    `;
                        ...
                        const backConfirmBtn = document.getElementById('confirmBackBtn');
                        const submitConfirmBtn = document.getElementById('confirmSubmitBtn');
                        const donasiForm = document.getElementById('donasiForm');

                        if (openConfirmBtn && confirmModal && donasiForm) {
                            // buka modal
                            ...
                            backConfirmBtn.addEventListener('click', closeModal);
