    ...
    <div class="flex-1 flex flex-col">
        ...
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-8">
            ...
            <div class="flex items-center gap-4">
                <button class="hidden sm:inline-flex items-center justify-center h-9 w-9 rounded-full border border-slate-200 text-slate-500">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="h-9 w-9 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-400 flex items-center justify-center text-white text-sm font-semibold">
        ...
        <main class="flex-1 px-4 md:px-8 py-6 space-y-6">
            ...
            <div class="rounded-xl border border-sky-200 bg-sky-50 px-4 py-3 text-sm text-sky-800">
                <div class="flex flex-col gap-1 md:flex-row md:items-center md:justify-between">
                    <p>
                        Dapatkan <span class="font-semibold">“Hadiah Kebaikan”</span> dengan membagikan kode referral DonasiKuy.
            ...
            <div class="grid gap-4 lg:grid-cols-3">
                ...
                <div class="rounded-2xl bg-white border border-slate-200 shadow-sm px-4 py-4 flex items-center gap-4">
                    <div class="h-12 w-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-400 flex items-center justify-center text-white">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm">
                        <thead class="bg-slate-50 border-b border-slate-200">
                            <tr>
                                <th class="text-left px-4 md:px-6 py-2 text-[11px] font-semibold text-slate-500 uppercase tracking-wide">
                                    Tanggal
                                </th>
                                <th class="text-right px-4 md:px-6 py-2 text-[11px] font-semibold text-slate-500 uppercase tracking-wide">
                                    Jumlah Donasi
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @empty
                                {{-- fallback: kalau mau selalu tampil 7 hari seperti Ayobantu, bisa di-generate di controller --}}
                                <tr>
